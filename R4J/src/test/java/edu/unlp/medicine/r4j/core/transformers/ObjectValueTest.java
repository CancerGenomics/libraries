package edu.unlp.medicine.r4j.core.transformers;
 ...
 *
 */
public class ObjectValueTest extends TestCase {
	/**
	...
	public void testGetValue() {
		try {
			...
			Assert.assertTrue(object.getValue("protocolData") instanceof R4JObjectValue);
			Assert.assertTrue(object.getValue("experimentData") instanceof R4JObjectValue);
